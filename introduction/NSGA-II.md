...
1. 首先有一初始的人口(親代)P<sub>t</sup></sub>內含N個染色體，經由突變及交配後產生子代Q<sub>t</sup></sub>。
2. 由於採用菁英策略，因此將親代與子代一同保留下來，進行挑選。
3. 接著進行非凌越排序，以得到每個解的非凌越層級 (F<sub>1</sup></sub><層級1>、F<sub>2</sup></sub><層級2>.....)。
4. 最後挑選新的N個染色體當成下一次迭代的人口，先依照非凌越層級高低來選擇，若發生如下圖所示的，剩餘要挑選進入新人口的染色體數小於下一個要被選擇的非凌越層級內的染色體的數，則透過擁擠距離來進行挑選，選擇擁擠距離較大者進入新的人口。
5. 最終產生新的人口P<sub>t+1</sup></sub>，進入下一次迭代，重複上述流程。
