...
另外，藉由此範例順便說明解碼 (Decoding) 的意義，因為 GA 中我們是透過編碼後的染色體來代表一個解，所以當要由染色體來推得原本的解時，就必須經過解碼的步驟，就如圖所示的，將染色體轉換回它所代表的實際數值，轉換的方式就取決於當初是怎麼設計這個染色體的。<br>
